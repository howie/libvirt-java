...
public interface Libvirt extends Library {
	...
	interface VirConnectDomainEventGenericCallback extends VirDomainEventCallback {
		...
		// There are two types of event call back.
		// Therefore, this call back interface is left blank.
		// A public event call back method should be implemented when using this interface to register events.
	}
	 ...
	 *             object. This method remains for backwards compatibility. Use {@link #virCopyLastError} instead.
	 */
	@Deprecated
